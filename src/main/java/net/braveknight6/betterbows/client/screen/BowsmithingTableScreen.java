...
public class BowsmithingTableScreen extends AbstractContainerScreen<BowsmithingTableMenu> {
    ...
    private static final Identifier TEXTURE =
            Identifier.fromNamespaceAndPath(BetterBows.MOD_ID, "textures/gui/container/bowsmithing_table.png");

    public BowsmithingTableScreen(BowsmithingTableMenu menu, Inventory playerInventory, Component title) {
    ...
    public void extractBackground(GuiGraphicsExtractor guiGraphicsExtractor, int mouseX, int mouseY, float a) {
        ...
        guiGraphicsExtractor.blit(RenderPipelines.GUI_TEXTURED, TEXTURE, x, y, 0, 0, this.imageWidth, this.imageHeight, 256, 256);
    }
}