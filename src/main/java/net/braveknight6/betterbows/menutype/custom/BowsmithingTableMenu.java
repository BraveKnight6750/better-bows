...
public class BowsmithingTableMenu extends AbstractContainerMenu{
    ...
    public ItemStack quickMoveStack(Player player, int slotIndex) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (slotIndex >= 10 && slotIndex < 46) { // Shift clicking from inventory INTO the crafting grid
            ...
            } else if (!this.moveItemStackTo(itemStack2, 10, 46, false)) { // Grid back to player inventory
                return ItemStack.EMPTY;
            }
    ...
    public void slotsChanged(Container container) {
        this.access.execute((level, pos) -> updateCraftingResult(this, level, this.player, this.craftSlots, this.resultSlots));
    }
    ...
    public static void updateCraftingResult(AbstractContainerMenu menu,
                                            Level level,
                                            Player player,
